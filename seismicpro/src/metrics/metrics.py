...
class PipelineMetric(PlottableMetric):
    ...
    def plot_view(self, coords, ax, batch_src, pipeline, view, **kwargs):
        if pipeline is None:
            if batch_src == "coords":
        ...
        getattr(self, view)(*coords_args, ax=ax, **coords_kwargs, **kwargs)
    ...
    def get_views(self, batch_src, pipeline, plot_component, *args, **kwargs):
        ...
        return [partial(self.plot_view, batch_src=batch_src, pipeline=pipeline, view=view) for view in self.views]
