...
class MetricsMap(Metrics):
    ...
    ValueError : If given coordinates has more then two values for one metrics value.
    TypeError : If given coordinates is not array-like.
